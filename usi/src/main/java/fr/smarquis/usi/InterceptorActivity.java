...
public class InterceptorActivity extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (nextIntent != null) {
            MenuItem restartItem = menu.add(R.string.usi_menu_restart).setIcon(R.drawable.usi_ic_repeat_white_36dp).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                @Override
        ...
        MenuItem settingsItem = menu.add(R.string.usi_menu_settings).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
